			...
			<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
				<TBODY>
					<TR>
						...
						<TD align="center" width=180 background=YHMenu.files/new_006.jpg height=35><B>人力资源 －功能菜单</B></TD>
								...
								<TBODY>
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_1');">
											<SPAN class=span id=table_1Span>＋</SPAN> 渠道商
										</TD>
									</TR>
									<TR>
										<TD>
											<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
												<TBODY>
													<TR>
														<TD class=menuSmall><A class=style2 href=/PersonPowerManagerSystem/index.jsp target=_top>－ 渠道商列表</A></TD>
													</TR>
													<TR>
														<TD class=menuSmall><A class=style2 href="YHAdd.jsp" target=dmMain>－ 新增渠道商</A></TD>
													</TR>
													<TR>
														<TD class=menuSmall><br /></TD>
													</TR>
													<TR>
														<TD class=menuSmall><br /></TD>
													</TR>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_2');">
											<SPAN class=span id=table_2Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_3');">
											<SPAN class=span id=table_3Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
											class=span id=table_4Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_5');">
											<SPAN class=span id=table_5Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_6');">
											<SPAN class=span id=table_6Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_7');">
											<SPAN class=span id=table_7Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_8');">
											<SPAN class=span id=table_8Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
									...
									<TR>
										<TD class=mainMenu onClick="MenuDisplay('table_9');">
											<SPAN class=span id=table_9Span>＋</SPAN> 
										</TD>
									</TR>
									<TR>
										<TD>
											<TABLE id=table_9 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
												<TBODY>
													<TR>
														<TD class=menuSmall><br /></TD>
													</TR>
			...
			<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
				<TBODY>
					<TR>
						...
						<TD align="center" width=180 background=YHMenu.files/new_011.jpg height=15></TD>
						<TD width=15><IMG src="YHMenu.files/new_012.jpg" border=0></TD>
					</TR>
				</TBODY>
			</TABLE>
		</FORM>
